...
import UserSidebar from '@/app/users/[userId]/_components/UserSidebar';
    ...
    <NullResponsiveWrapper>
      <div className='h-screen w-full overflow-hidden'>
        <div className='grid h-screen w-full grid-rows-[auto_1fr] grid-cols-1 overflow-hidden'>
          ...
          <main className='row-start-2 row-span-1 grid h-full w-full grid-rows-1 grid-cols-[auto_1fr] overflow-hidden bg-[#FAFAFA]'>
            <UserSidebar />
